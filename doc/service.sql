...
CREATE TABLE `activityaudio` (
  ...
  `type` varchar(2) DEFAULT NULL COMMENT '音频类型',
  `typeId` int(11) DEFAULT NULL COMMENT '音频对应的类型id',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `activityaudio_type_typeId_index` (`type`,`typeId`) USING BTREE COMMENT '索引 类型 类型id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of activityaudio
-- ----------------------------
...
CREATE TABLE `activitybeautifulgreat` (
  `stuNum` varchar(20) NOT NULL COMMENT '最美活动参与者',
  `fromStuNum` varchar(20) NOT NULL COMMENT '最美活动点赞人',
...
CREATE TABLE `activityimage` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `activityimage_type_typeId_index` (`type`,`typeId`) USING BTREE COMMENT '索引 类型 类型id'
...
CREATE TABLE `activityvideo` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `src` varchar(1000) DEFAULT NULL COMMENT '地址',
  `type` varchar(2) DEFAULT NULL COMMENT '视频类型',
  `typeId` int(11) DEFAULT NULL COMMENT '视频对应的类型id',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `activityvideo_type_typeId_index` (`type`,`typeId`) USING BTREE COMMENT '索引 类型 类型id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of activityvideo
-- ----------------------------
...
CREATE TABLE `audio` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `src` varchar(255) DEFAULT NULL COMMENT '音频地址',
  `type` varchar(2) DEFAULT NULL COMMENT '类型',
  `typeId` int(11) DEFAULT NULL COMMENT '类型的主键',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
INSERT INTO `audio` VALUES ('2', 'https://sharefs.yun.kugou.com/202101212059/2c804e917d232565a46ba76c7868f93b/KGTX/CLTX001/f8784ebfbae36b324ec1e3441b6156b4.mp3', '03', '2');
INSERT INTO `audio` VALUES ('3', 'https://sharefs.yun.kugou.com/202101212222/12c997e1c077453f297024432e7b0814/G186/M09/05/04/mpQEAF5YcgGAF7r4AEWzEq3F8_E323.mp3', '03', '4');
...
CREATE TABLE `comment` (
  ...
  `type` varchar(2) DEFAULT NULL COMMENT '类型',
  `typeId` int(11) DEFAULT NULL COMMENT '类型的主键',
  `stuNum` varchar(20) DEFAULT NULL COMMENT '评论人',
...
CREATE TABLE `express` (
  ...
  `count` int(2) DEFAULT NULL COMMENT '数量',
  `createTime` varchar(19) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `image` (
  ...
  `typeId` int(11) DEFAULT NULL COMMENT '图片对应的类型id',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `image_type_typeId_index` (`type`,`typeId`) USING BTREE COMMENT '索引 类型 类型id'
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `lost` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `stuNum` varchar(20) DEFAULT NULL COMMENT '学号',
  `getTime` varchar(19) DEFAULT NULL COMMENT '捡到的时间',
  `place` varchar(255) DEFAULT NULL COMMENT '地点',
...
CREATE TABLE `message` (
  ...
  `createTime` varchar(19) DEFAULT NULL COMMENT '创建时间',
  `readFlag` varchar(1) DEFAULT 'N' COMMENT '读取标识（已读：Y  未读：N）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `video` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `src` varchar(255) DEFAULT NULL COMMENT '视频地址',
  `type` varchar(2) DEFAULT NULL COMMENT '类型',
  `typeId` int(11) DEFAULT NULL COMMENT '类型的主键',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
